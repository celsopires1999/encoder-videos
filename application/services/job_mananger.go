...
import (
	...
	"github.com/celsopires1999/encoder/framework/queue"
...
func (j *JobManager) Start(ch *amqp.Channel) {
	...
	for processID := 0; processID < concurrency; processID++ {
		go JobWorker(j.MessageChannel, j.JobReturnChannel, jobService, j.Domain, processID)
	}
